...
```
cd existing_repo
git remote add origin http://gitlab.rapidor.co/adhil.backer/oaas-products.git
git branch -M main
...
- [ ] [Set up project integrations](http://gitlab.rapidor.co/adhil.backer/oaas-products/-/settings/integrations)
